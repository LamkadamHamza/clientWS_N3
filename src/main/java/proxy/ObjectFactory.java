...
public class ObjectFactory {
    ...
    private final static QName _Liscomptes_QNAME = new QName("http://WS/", "liscomptes");
    private final static QName _LiscomptesResponse_QNAME = new QName("http://WS/", "liscomptesResponse");
